                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 mt-2">
                            <div class="form-group">
                                <strong>Titel:</strong>
                                <input name="title" placeholder="Titel" class="form-control" value="{{ old('title') }}" type="text">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="description" style="height=150px;"
                                    value="{{ old('description') }}" placeholder="Beskrivelse"></textarea>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-joined" style="width: 16.5rem;">
                                    ...
                                    <input id="date" class="datepicker form-control" type="text" name="start_date"
                                        placeholder="Tryk for at vælge dato" value="{{ old('start_date') }}" required>
                                </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 d-flex justify-content-center">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-joined">
                                    <input type="text" name="filter" class="form-control" placeholder="Indtast filter" data-role="tagsinput" >
                                </div>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('input[name="filter"]').change(function() {
                $(".tag").removeClass('label').removeClass('label-info').addClass('badge').addClass('badge-info');
            })
        });
    </script>
@endsection
